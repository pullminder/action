...
The Pullminder CLI does not use session-based auth. For platform commands that require authentication (such as syncing results with the dashboard), the CLI uses a `GITHUB_TOKEN` environment variable. See the [CLI installation guide](https://docs.pullminder.com/cli/installation/) for details.
...
- [API endpoints](https://docs.pullminder.com/api/endpoints/) -- complete reference for all REST endpoints
- [Webhooks](https://docs.pullminder.com/api/webhooks/) -- GitHub webhook integration details
...
:::note
This is a dashboard API, not a public API. Authentication is session-based via GitHub OAuth cookies. See the [Authentication](https://docs.pullminder.com/api/authentication/) guide for details.
:::
...
- [Authentication](https://docs.pullminder.com/api/authentication/) -- how session-based auth works
- [Webhooks](https://docs.pullminder.com/api/webhooks/) -- GitHub webhook event handling
...
Sessions have a 7-day maximum age and a 30-minute inactivity timeout. Once a session expires, the API returns `401 Unauthorized` and the user must re-authenticate via the [GitHub OAuth flow](https://docs.pullminder.com/api/authentication/).

## Next steps

- [Authentication](https://docs.pullminder.com/api/authentication/) -- session-based auth via GitHub OAuth
- [API endpoints](https://docs.pullminder.com/api/endpoints/) -- complete reference for all REST endpoints
- [Webhooks](https://docs.pullminder.com/api/webhooks/) -- GitHub webhook integration details
...
If you have configured a Slack incoming webhook URL in your [dashboard settings](https://docs.pullminder.com/dashboard/settings/), Pullminder sends notifications to your Slack channel when certain events occur.
...
- [Authentication](https://docs.pullminder.com/api/authentication/) -- how session-based auth works
- [API endpoints](https://docs.pullminder.com/api/endpoints/) -- complete reference for all REST endpoints
- [Dashboard settings](https://docs.pullminder.com/dashboard/settings/) -- configure Slack and notification preferences
